...
export const NotificationPopover: React.FC<NotificationPopoverProps> = ({ 
  ...
  if (notifications.length === 0) {
    return (
      <div className="absolute top-12 right-0 w-80 bg-[#25262B] border border-[#363840] rounded-lg shadow-xl z-50 p-4 flex flex-col items-center justify-center text-gray-500 animate-in fade-in zoom-in-95 duration-200">
  ...
  return (
    <div className="absolute top-12 right-0 w-80 bg-[#25262B] border border-[#363840] rounded-lg shadow-xl z-50 animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[400px]">
