              ...
              <div className="grid grid-cols-4 gap-6">
                <div className="col-span-3 space-y-3">
                  ...
                  <input
                    ...
                    className="w-full bg-[#14151A] border border-[#22242A] rounded-xl px-5 py-3.5 text-sm text-[#E8E8E8] focus:outline-none focus:border-accent/50 focus:ring-4 focus:ring-accent/5 transition-all placeholder:text-[#2C2D35] font-medium"
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full bg-[#14151A] border border-[#22242A] rounded-xl px-3 py-3.5 text-sm text-accent focus:outline-none focus:border-accent/50 font-mono text-center font-bold tracking-[0.2em]"
                    placeholder="ID"
                    maxLength={3}
                  />
                </div>
                  ...
                  <div className="flex-1 grid grid-cols-8 gap-1 p-2 max-h-24 overflow-y-auto no-scrollbar">
                    {['⚡', '🚀', '🎯', '📦', '🔧', '🎨', '📱', '💻', '📊', '📈', '🔒', '🛡️', '⚙️', '🔨', '📁', '💼', '✅', '🎉', '⭐', '💎', '🔥', '❤️', '🌍', '🛠️'].map(emoji => (
                      <button
                        ...
                        className={`w-9 h-9 flex items-center justify-center rounded-lg transition-all text-xl ${icon === emoji ? 'bg-accent text-white shadow-lg shadow-accent/20 scale-95' : 'hover:bg-[#1A1C23] text-[#3A3C46] hover:text-[#C0C4CC]'}`}
                      >
                        {emoji}
                      </button>
                    ))}
              ...
              <div className="pt-8 border-t border-[#1A1C23] flex items-center justify-between">
                ...
                <div className="flex space-x-6">
                  ...
                  <button
                    ...
                    className="px-8 py-3 bg-accent hover:bg-accent-hover text-white text-[11px] font-bold rounded-xl transition-all disabled:opacity-20 disabled:grayscale uppercase tracking-[0.2em] shadow-xl shadow-accent/20 flex items-center space-x-2 group"
                  >
