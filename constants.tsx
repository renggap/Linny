...
export const MOCK_USERS: User[] = [
  { id: 'u1', name: 'Alex Rivera', email: 'alex@acme.com', avatarUrl: 'https://picsum.photos/32/32?random=1', password: 'password', role: UserRole.Admin },
  ...
  { id: 'u3', name: 'Jordan Smith', email: 'jordan@acme.com', avatarUrl: 'https://picsum.photos/32/32?random=3', password: 'password', role: UserRole.Viewer },
];
...
export const MOCK_PROJECTS: Project[] = [
  { id: 'p1', name: 'Linear Clone', identifier: 'LIN', icon: '⚡', teamId: 't1' },
